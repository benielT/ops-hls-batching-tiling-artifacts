// Auto-generated at 2025-09-06 14:47:20.671107 by ops-translator
...
public:
    ...
    )
    {
        ...
        OCL_CHECK(err, err = m_kernel_1.setArg(narg++, *param_k));
        narg = 0; 
        ...
        OCL_CHECK(err, err = m_kernel_2.setArg(narg++, *param_k));
...
/*
        ...
        cl::Event event_arg1_arg0_bufCpy;
        size_t arg1_total_bytes = arg1.originalProperty.grid_size[0] * arg1.originalProperty.grid_size[1] * arg1.originalProperty.grid_size[2] * sizeof(stencil_type);

        if (adjusted_outer_iter %2 != 0)
        {
            OCL_CHECK(err, err = m_fpga->getCommandQueue().enqueueCopyBuffer(arg1.deviceBuffer, arg0.deviceBuffer, 0, 0, arg1_total_bytes, &activeEvents, &event_arg1_arg0_bufCpy));
        }
        else
        {
            OCL_CHECK(err, err = m_fpga->getCommandQueue().enqueueCopyBuffer(arg0.deviceBuffer, arg1.deviceBuffer, 0, 0, arg1_total_bytes, &activeEvents, &event_arg1_arg0_bufCpy));
        }
#ifndef ASYNC_DISPATCH
        event_arg1_arg0_bufCpy.wait();
#endif
*/
    }
private:
