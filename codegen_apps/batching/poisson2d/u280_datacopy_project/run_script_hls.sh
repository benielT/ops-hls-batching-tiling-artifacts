    ...
    if [[ "${TARGET_MODE}" == "hw" ]]; then
        if [[ "${PLATFORM}" == *"u280"* ]]; then
            parameter_sets=(
                ...
                # "400,300,60102,50,1"
                # "400,400,60102,50,1"
                "60,60,60102,10000,10"
                "30,30,60102,10000,10"
                "100,100,60102,5000,10"
                "200,100,60102,5000,10"
                "200,200,60102,5000,10"
                "300,150,60102,2500,10"
                "300,300,60102,1000,10"
                # "400,200,60102,100,10"
                # "400,300,60102,100,10"
                # "400,400,60102,100,10"
                "30,30,60102,10000,20"
                "60,60,60102,10000,20"
                "100,100,60102,5000,20"
                "200,100,60102,5000,20"
                "200,200,60102,5000,20"
                "300,150,60102,2500,20"
                "300,300,60102,1000,20"
                # "400,200,60102,100,20"
                # "400,300,60102,100,20"
                # "400,400,60102,100,20"
                "30,30,60102,10000,50"
                "60,60,60102,10000,50"
                "100,100,60102,5000,50"
                "200,100,60102,5000,50"
                "200,200,60102,5000,50"
                "300,150,60102,2500,50"
                "300,300,60102,1000,50"
                # "400,200,60102,100,50"
                # "400,300,60102,100,50"
                # "400,400,60102,100,50"
                "30,30,60102,10000,100"
                "60,60,60102,10000,100"
                "100,100,60102,5000,100"
                "200,100,60102,5000,100"
                "200,200,60102,5000,100"
                "300,150,60102,2500,100"
                "300,300,60102,1000,100"
