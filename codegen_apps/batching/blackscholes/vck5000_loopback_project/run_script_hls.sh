        ...
        if [[ "${PLATFORM}" == *"u280"* ]]; then
            parameter_sets=(
                ...
                parameter_sets=(
                    ...
                    "200,60000,200000,20"
                    "500,60000,200000,20"
                    "1000,60000,100000,20"
                    "2000,60000,100000,20"
                    "100,60000,400000,50"
                    "150,60000,400000,50"
                    "200,60000,400000,50"
                    "500,60000,200000,50"
                    "1000,60000,200000,50"
                    "100,60000,400000,100"
                    "150,60000,400000,100"
                    "200,60000,400000,100"
                    "500,60000,400000,100"
                    "100,60000,800000,200"
                    "150,60000,800000,200"
                    "200,60000,800000,200"
                # Add more parameter sets here as needed
            )
            fi
        else
