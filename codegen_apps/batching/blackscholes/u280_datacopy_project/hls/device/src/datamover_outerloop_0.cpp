// Auto-generated at 2026-07-26 21:35:16.719082 by ops-translator
...
#pragma HLS DATAFLOW
    ...
    ops::hls::axis2stream<axis_data_width>(arg3_axis_in, arg3_write_reduced_mem_strm, num_pkts);
...

{
    ...
    #pragma HLS INTERFACE mode=m_axi bundle=gmem0 depth=4096 max_read_burst_length=32 max_write_burst_length=32 \
    ...
    #pragma HLS INTERFACE mode=m_axi bundle=gmem1 depth=4096 max_read_burst_length=32 max_write_burst_length=32 \
            num_read_outstanding=2 num_write_outstanding=2 \
            port=arg1 offset=slave latency=40
    #pragma HLS INTERFACE s_axilite port = arg1 bundle = control
 
    #pragma HLS INTERFACE mode=m_axi bundle=gmem2 depth=4096 max_read_burst_length=32 max_write_burst_length=32 \
            num_read_outstanding=2 num_write_outstanding=2 \
            port=arg2 offset=slave latency=40
    #pragma HLS INTERFACE s_axilite port = arg2 bundle = control
 
    #pragma HLS INTERFACE mode=m_axi bundle=gmem3 depth=4096 max_read_burst_length=32 max_write_burst_length=32 \
            num_read_outstanding=2 num_write_outstanding=2 \
            port=arg3 offset=slave latency=40
    #pragma HLS INTERFACE s_axilite port = arg3 bundle = control
 
    #pragma HLS INTERFACE mode=m_axi bundle=gmem4 depth=4096 max_read_burst_length=32 max_write_burst_length=32 \
            num_read_outstanding=2 num_write_outstanding=2 \
