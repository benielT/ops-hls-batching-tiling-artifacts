    ...
    if [[ "${TARGET_MODE}" == "hw" ]]; then
        ...
        if [[ "${PLATFORM}" == *"u280"* ]]; then
            parameter_sets=(
                    ...
                    "5000,60060,20000,20"
                    "2000,60060,20000,20"
                    "10000,60060,20000,20"
                    "20000,60060,10000,20"
                    "30000,60060,5000,20"
                    "100,60060,20000,50"
                    "150,60060,20000,50"
                    "200,60060,20000,50"
                    ...
                    "5000,60060,20000,50"
                    "2000,60060,20000,50"
                    "10000,60060,20000,50"
                    "20000,60060,10000,50"
                    "30000,60060,5000,50"
                    "100,60060,5000,100"
                    "150,60060,5000,100"
                    "200,60060,5000,100"
                    ...
                    "5000,60060,5000,100"
                    "2000,60060,5000,100"
                    "10000,60060,5000,100"
                    "20000,60060,5000,100"
                    "30000,60060,5000,100"
                    "100,60060,5000,200"
                    "150,60060,5000,200"
                    "200,60060,5000,200"
                    "500,60060,5000,200"
                    ...
                    "5000,60060,5000,200"
                    "2000,60060,5000,200"
                    "10000,60060,5000,200"
                    "20000,60060,5000,200"
                    "30000,60060,5000,200"
