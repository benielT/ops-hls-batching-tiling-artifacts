    ...
    if [[ "${TARGET_MODE}" == "hw" ]]; then
        if [[ "${PLATFORM}" == *"u280"* ]]; then
            ...
            parameter_sets=(
                ...
                # "200,100,60060,5000,10"
                # "200,200,60060,5000,10"
                # "300,150,60060,2500,10"
                # "300,300,60060,1000,10"
                # "400,200,60060,1000,10"
                # "400,300,60060,1000,10"
                # "400,400,60060,1000,10"
                # "30,30,60060,10000,20"
                # "60,60,60060,10000,20"
                # "100,100,60060,5000,20"
                "200,100,60060,5000,20"
                "200,200,60060,5000,20"
                "300,150,60060,2000,20"
                "300,300,60060,1000,20"
                "400,200,60060,1000,20"
                "400,300,60060,1000,20"
                "400,400,60060,1000,20"
                # "30,30,60060,10000,50"
                # "60,60,60060,10000,50"
                # "100,100,60060,5000,50"
                # "200,100,60060,5000,50"
                # "200,200,60060,5000,50"
                # "300,150,60060,2000,50"
                # "300,300,60060,1000,50"
                # "400,200,60060,1000,50"
                # "400,300,60060,1000,50"
                # "400,400,60060,1000,50"
                # "30,30,60060,10000,100"
                # "60,60,60060,10000,100"
                # "100,100,60060,5000,100"
                # "200,100,60060,5000,100"
                # "200,200,60060,5000,100"
                # "300,150,60060,3000,100"
                # "300,300,60060,2000,100"
                # "400,200,60060,2000,100"
                # "400,300,60060,1000,100"
                # "400,400,60060,1000,100"
                # Add more parameter sets here as needed
            )
        fi
    else
    ...
    if [[ "${TARGET_MODE}" == "hw" ]]; then
        if [[ "${PLATFORM}" == *"u280"* ]]; then
            ...
            parameter_sets=(
                ...
                "200,100,60060,100,10"
                "200,200,60060,100,10"
                "300,150,60060,20,10"
                "300,300,60060,20,10"
                "400,200,60060,20,10"
                "400,300,60060,20,10"
                ...
                "30,30,60060,100,20"
                "60,60,60060,100,20"
                "100,100,60060,100,20"
                "200,100,60060,100,20"
                "200,200,60060,100,20"
                "300,150,60060,20,20"
                "300,300,60060,20,20"
                "400,200,60060,20,20"
                "400,300,60060,20,20"
                ...
                "30,30,60060,100,50"
                "60,60,60060,100,50"
                "100,100,60060,100,50"
                "200,200,60060,100,50"
                "200,100,60060,100,50"
                "300,150,60060,50,50"
                "300,300,60060,50,50"
                "400,200,60060,50,50"
                "400,300,60060,50,50"
                ...
                "30,30,60060,100,100"
                "60,60,60060,100,100"
                "100,100,60060,100,100"
                "200,100,60060,100,100"
                "200,200,60060,100,100"
                "300,150,60060,100,100"
                "300,300,60060,100,100"
                "400,200,60060,100,100"
                "400,300,60060,100,100"
                "400,400,60060,100,100"
                # Add more parameter sets here as needed
                )
        fi
    else
