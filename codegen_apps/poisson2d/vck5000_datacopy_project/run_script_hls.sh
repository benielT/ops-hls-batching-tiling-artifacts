    ...
    if [[ "${TARGET_MODE}" == "hw" ]]; then
        if [[ "${PLATFORM}" == *"u280"* ]]; then
            ...
            parameter_sets=(
                ...
                "60,60,60060,1000,10"
                "30,30,60060,1000,10"
                "100,100,60060,500,10"
                "200,100,60060,500,10"
                "200,200,60060,500,10"
                "300,150,60060,250,10"
                "300,300,60060,100,10"
                "400,200,60060,100,10"
                "400,300,60060,100,10"
                "400,400,60060,100,10"
                "30,30,60060,1000,20"
                "60,60,60060,1000,20"
                "100,100,60060,500,20"
                "200,100,60060,500,20"
                "200,200,60060,500,20"
                "300,150,60060,250,20"
                "300,300,60060,100,20"
                "400,200,60060,100,20"
                "400,300,60060,100,20"
                "400,400,60060,100,20"
                "30,30,60060,10000,50"
                "60,60,60060,1000,50"
                "100,100,60060,500,50"
                "200,100,60060,500,50"
                "200,200,60060,500,50"
                "300,150,60060,250,50"
                "300,300,60060,100,50"
                "400,200,60060,100,50"
                "400,300,60060,100,50"
                "400,400,60060,100,50"
                "30,30,60060,1000,100"
                "60,60,60060,1000,100"
                "100,100,60060,500,100"
                "200,100,60060,500,100"
                "200,200,60060,500,100"
                "300,150,60060,250,100"
