        ...
        if [[ "${CXXFLAGS}" == *"-DBATCHING"* ]]; then
            if [[ "${PLATFORM}" == *"u280"* ]]; then
                ...
                parameter_sets=(
                    ...
                    "200,100,60012,500,10"
                    "200,200,60012,500,10"
                    "300,150,60012,250,10"
                    "300,300,60012,100,10"
                    "400,200,60012,100,10"
                    "400,300,60012,100,10"
                    "400,400,60012,100,10"
                    "30,30,60012,1000,20"
                    "60,60,60012,1000,20"
                    "100,100,60012,500,20"
                    "200,100,60012,500,20"
                    "200,200,60012,500,20"
                    "300,150,60012,300,20"
                    "300,300,60012,200,20"
                    "400,200,60012,100,20"
                    "400,300,60012,100,20"
                    "400,400,60012,100,20"
                    "30,30,60012,10000,50"
                    "60,60,60012,1000,50"
                    "100,100,60012,500,50"
                    "200,100,60012,500,50"
                    "200,200,60012,500,50"
                    "300,150,60012,250,50"
                    "300,300,60012,100,50"
                    "400,200,60012,100,50"
                    "400,300,60012,100,50"
                    "400,400,60012,100,50"
                    "100,100,60012,500,100"
                    "200,100,60012,500,100"
                    "200,200,60012,500,100"
                    "300,150,60012,300,100"
                    "300,300,60012,200,100"
                    "400,200,60012,200,100"
                    "400,300,60012,200,100"
                    "400,400,60012,200,100"
                    # Add more parameter sets here as needed
                )
            fi
        else
        ...
        if [[ "${CXXFLAGS}" == *"-DBATCHING"* ]]; then
            if [[ "${PLATFORM}" == *"u280"* ]]; then
                ...
                parameter_sets=(
                    ...
                    "300,150,60012,100,100"
                    "300,300,60012,100,100"
                    "400,200,60012,100,100"
                    "400,300,60012,100,100"
                    "400,400,60012,100,100"
                    # Add more parameter sets here as needed
                    )
            fi
        else
