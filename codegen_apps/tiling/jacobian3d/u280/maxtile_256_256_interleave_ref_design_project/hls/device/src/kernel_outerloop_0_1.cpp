...
static void kernel_outerloop_0_dataflow_region_cascaded(const unsigned short& slr_region, const ops::hls::StencilConfigCoreSingleTile& stencilConfig,
    ::hls::stream<ap_uint<axis_data_width>> arg0_arg1_u_streams[iter_par_factor_1 + 1], ::hls::stream<ap_uint<axis_data_width>> arg0_arg1_l_streams[iter_par_factor_1 + 1], 
    const unsigned int num_pkts
)
{
#pragma HLS INLINE 

    const unsigned short PEId_offset = 1;
...
{
#pragma HLS DATAFLOW
    ::hls::stream<ap_uint<axis_data_width>> arg0_arg1_u_streams[iter_par_factor_1 + 1];
    #pragma HLS STREAM variable = arg0_arg1_u_streams depth = 66
    ::hls::stream<ap_uint<axis_data_width>> arg0_arg1_l_streams[iter_par_factor_1 + 1];
    #pragma HLS STREAM variable = arg0_arg1_l_streams depth = 66
    
        ops::hls::axis2stream<axis_data_width>(arg0_u_axis_in, arg0_arg1_u_streams[0], num_pkts);//, true);
        ...
        ops::hls::stream2axis<axis_data_width>(arg0_arg1_u_streams[iter_par_factor_1], arg1_u_axis_out,  num_pkts);//, false);
        ops::hls::stream2axis<axis_data_width>(arg0_arg1_l_streams[iter_par_factor_1], arg1_l_axis_out,  num_pkts);//, false);
