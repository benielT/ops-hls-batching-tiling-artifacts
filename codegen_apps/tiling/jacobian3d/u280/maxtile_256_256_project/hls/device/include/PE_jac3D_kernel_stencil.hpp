// Auto-generated at 2026-03-11 15:59:43.778522 by ops-translator
...
/*
    ArgDat(id=0, loc=/scratch/hpc-prf-acgasm/beniel/jac3d/u280_2_9_9/jac3D7pt.cpp/330:21, access_type=AccessType.OPS_READ, opt=True, dat_id=0, global_dat_id=-1, stencil_id=S3D_7PT)
    ArgDat(id=1, loc=/scratch/hpc-prf-acgasm/beniel/jac3d/u280_2_9_9/jac3D7pt.cpp/331:21, access_type=AccessType.OPS_WRITE, opt=True, dat_id=1, global_dat_id=-1, stencil_id=S3D_00)
*/
...
public:
        ...
        )
    {
        ...
        const unsigned short true_tile_size_x = stencilConfig.tile_size[0] << shift_bits;
        // overlap_size = 64, total_PEs = 20 
        // const unsigned short overlap_offset_x = 43;
...
#ifdef DEBUG_LOG
    printf("[KERNEL_DEBUG]|%s| stencil config gridSize: %d (xblocks), %d, %d\n", __func__, stencilConfig.tile_size[0], stencilConfig.tile_size[1], stencilConfig.tile_size[2]);
#endif
