// Auto-generated at 2026-03-11 15:59:44.065081 by ops-translator
...
static void kernel_outerloop_0_dataflow_region_cascaded(const unsigned short& slr_region, const ops::hls::StencilConfigCoreSingleTile& stencilConfig,
    ::hls::stream<ap_uint<axis_data_width>> arg0_arg1_streams[iter_par_factor_1 + 1]
)
{
#pragma HLS INLINE 

    const unsigned short PEId_offset = 2;
...
::hls::stream<ap_uint<axis_data_width>> arg0_arg1_streams[iter_par_factor_1 + 1];
    #pragma HLS STREAM variable = arg0_arg1_streams depth = 66
        ...
        ops::hls::stream2axis<axis_data_width>(arg0_arg1_streams[iter_par_factor_1], arg1_axis_out,  num_pkts);
