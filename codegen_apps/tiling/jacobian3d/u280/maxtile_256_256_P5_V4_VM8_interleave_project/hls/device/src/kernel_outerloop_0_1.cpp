// Auto-generated at 2026-07-05 14:05:30.462617 by ops-translator
...
static void kernel_outerloop_0_dataflow_region_cascaded(const unsigned short slr_region, const ops::hls::StencilConfigCoreSingleTile stencilConfig,
    ...
    ::hls::stream<ap_uint<axis_data_width>> arg0_arg1_streams[iter_par_factor_1 + 1][8]
)
{
#pragma HLS INLINE 

    constexpr unsigned short PEId_offset = 1;
        ::hls::stream<ap_uint<axis_data_width>> node2_1_to_node3_0[iter_par_factor_1][8];
    #pragma HLS STREAM variable = node2_1_to_node3_0 depth = 10
    ::hls::stream<ap_uint<half_axis_data_width_jac3D_kernel_stencil_0>> arg0_jac3D_kernel_stencil_subtile_stream[iter_par_factor_1][8];
    #pragma HLS STREAM variable = arg0_jac3D_kernel_stencil_subtile_stream depth = 10
    ::hls::stream<ap_uint<half_axis_data_width_jac3D_kernel_stencil_1>> arg1_jac3D_kernel_stencil_subtile_stream[iter_par_factor_1][8];
    #pragma HLS STREAM variable = arg1_jac3D_kernel_stencil_subtile_stream depth = 10
...
#pragma HLS UNROLL factor=iter_par_factor_1
    ...
    ops::hls::stream2interleave<axis_data_width, 32, 8, 1>(arg0_arg1_streams[i], arg0_jac3D_kernel_stencil_subtile_stream[i], num_pkts);
    kernel_jac3D_kernel_stencil_PE<4, 0>(
                PEId_offset, i, 
                stencilConfig,
                arg0_jac3D_kernel_stencil_subtile_stream[i][0],
                arg0_jac3D_kernel_stencil_subtile_stream[i][1],
                arg1_jac3D_kernel_stencil_subtile_stream[i][0],
                arg1_jac3D_kernel_stencil_subtile_stream[i][1]
  
            );
    kernel_jac3D_kernel_stencil_PE<4, 1>(
                PEId_offset, i, 
                stencilConfig,
                arg0_jac3D_kernel_stencil_subtile_stream[i][2],
                arg0_jac3D_kernel_stencil_subtile_stream[i][3],
                arg1_jac3D_kernel_stencil_subtile_stream[i][2],
                arg1_jac3D_kernel_stencil_subtile_stream[i][3]
  
            );
    kernel_jac3D_kernel_stencil_PE<4, 2>(
                PEId_offset, i, 
                stencilConfig,
                arg0_jac3D_kernel_stencil_subtile_stream[i][4],
                arg0_jac3D_kernel_stencil_subtile_stream[i][5],
                arg1_jac3D_kernel_stencil_subtile_stream[i][4],
                arg1_jac3D_kernel_stencil_subtile_stream[i][5]
  
            );
    kernel_jac3D_kernel_stencil_PE<4, 3>(
                PEId_offset, i, 
                stencilConfig,
                arg0_jac3D_kernel_stencil_subtile_stream[i][6],
                arg0_jac3D_kernel_stencil_subtile_stream[i][7],
                arg1_jac3D_kernel_stencil_subtile_stream[i][6],
                arg1_jac3D_kernel_stencil_subtile_stream[i][7]
  
            );
    ops::hls::interleave2stream<axis_data_width, 32, 8, 1>(arg1_jac3D_kernel_stencil_subtile_stream[i], arg0_arg1_streams[i+1], num_pkts);
...
#pragma HLS DATAFLOW
    ::hls::stream<ap_uint<axis_data_width>> arg0_arg1_streams[iter_par_factor_1 + 1][8];
    #pragma HLS ARRAY_PARTITION variable = arg0_arg1_streams dim = 2 complete
    #pragma HLS STREAM variable = arg0_arg1_streams depth = 18
 ...
 arg0_arg1_streams);
        ...
        ops::hls::stream2axis<axis_data_width>(arg0_arg1_streams[iter_par_factor_1][0], arg1_0_axis_out,  num_pkts);
        ops::hls::stream2axis<axis_data_width>(arg0_arg1_streams[iter_par_factor_1][1], arg1_1_axis_out,  num_pkts);
        ops::hls::stream2axis<axis_data_width>(arg0_arg1_streams[iter_par_factor_1][2], arg1_2_axis_out,  num_pkts);
        ops::hls::stream2axis<axis_data_width>(arg0_arg1_streams[iter_par_factor_1][3], arg1_3_axis_out,  num_pkts);
        ops::hls::stream2axis<axis_data_width>(arg0_arg1_streams[iter_par_factor_1][4], arg1_4_axis_out,  num_pkts);
        ops::hls::stream2axis<axis_data_width>(arg0_arg1_streams[iter_par_factor_1][5], arg1_5_axis_out,  num_pkts);
        ops::hls::stream2axis<axis_data_width>(arg0_arg1_streams[iter_par_factor_1][6], arg1_6_axis_out,  num_pkts);
        ops::hls::stream2axis<axis_data_width>(arg0_arg1_streams[iter_par_factor_1][7], arg1_7_axis_out,  num_pkts);
    ...
    )
{
    ...
    //#pragma HLS PIPELINE
            ...
            const unsigned int mem_tile_size_x = tile_size_x >> 1;
            const unsigned int widen_tile_size_x = ((mem_tile_size_x + 7) >> 3) << 1;
