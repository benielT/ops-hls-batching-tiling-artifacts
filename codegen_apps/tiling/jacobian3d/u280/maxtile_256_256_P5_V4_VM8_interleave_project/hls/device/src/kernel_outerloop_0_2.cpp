// Auto-generated at 2026-07-05 14:05:30.465742 by ops-translator
...
static void kernel_outerloop_0_dataflow_region_cascaded(const unsigned short slr_region, const ops::hls::StencilConfigCoreSingleTile stencilConfig,
    ...
    ::hls::stream<ap_uint<axis_data_width>> arg0_arg1_streams[iter_par_factor_2 + 1][8]
)
{
#pragma HLS INLINE 

    constexpr unsigned short PEId_offset = 3;
        ::hls::stream<ap_uint<axis_data_width>> node2_1_to_node3_0[iter_par_factor_2][8];
    #pragma HLS STREAM variable = node2_1_to_node3_0 depth = 10
    ::hls::stream<ap_uint<half_axis_data_width_jac3D_kernel_stencil_0>> arg0_jac3D_kernel_stencil_subtile_stream[iter_par_factor_2][8];
    #pragma HLS STREAM variable = arg0_jac3D_kernel_stencil_subtile_stream depth = 10
    ::hls::stream<ap_uint<half_axis_data_width_jac3D_kernel_stencil_1>> arg1_jac3D_kernel_stencil_subtile_stream[iter_par_factor_2][8];
...
#pragma HLS DATAFLOW
 ...
 arg0_arg1_streams);
        ...
        ops::hls::stream2axis<axis_data_width>(arg0_arg1_streams[iter_par_factor_2][0], arg1_0_axis_out,  num_pkts);
        ops::hls::stream2axis<axis_data_width>(arg0_arg1_streams[iter_par_factor_2][1], arg1_1_axis_out,  num_pkts);
        ops::hls::stream2axis<axis_data_width>(arg0_arg1_streams[iter_par_factor_2][2], arg1_2_axis_out,  num_pkts);
        ops::hls::stream2axis<axis_data_width>(arg0_arg1_streams[iter_par_factor_2][3], arg1_3_axis_out,  num_pkts);
        ops::hls::stream2axis<axis_data_width>(arg0_arg1_streams[iter_par_factor_2][4], arg1_4_axis_out,  num_pkts);
        ops::hls::stream2axis<axis_data_width>(arg0_arg1_streams[iter_par_factor_2][5], arg1_5_axis_out,  num_pkts);
        ops::hls::stream2axis<axis_data_width>(arg0_arg1_streams[iter_par_factor_2][6], arg1_6_axis_out,  num_pkts);
        ops::hls::stream2axis<axis_data_width>(arg0_arg1_streams[iter_par_factor_2][7], arg1_7_axis_out,  num_pkts);
