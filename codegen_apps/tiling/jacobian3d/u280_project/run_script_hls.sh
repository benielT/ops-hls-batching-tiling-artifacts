...
if [[ "${CXXFLAGS}" == *"-DPOWER_PROFILE"* ]]; then
    ...
    if [[ "${TARGET_MODE}" == "hw" ]]; then
        ...
        if [[ "${PLATFORM}" == *"u280"* ]]; then
            parameter_sets=(
                "30,30,30,108,2,100,100"
                "30,30,30,60048,10,128,128"
                "50,50,50,60048,10,128,128"
                "100,100,100,60048,5,128,128"
                "200,200,200,60048,3,128,128"
                "300,300,300,60048,2,128,128"
                "400,400,400,60048,1,128,128"
