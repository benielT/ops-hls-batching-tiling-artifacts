// Auto-generated at 2026-08-13 00:16:01.961022 by ops-translator
...
)    
{
    ...
    #pragma HLS STREAM variable = arg0_read_mem_redirect_strm 
    ...
    #pragma HLS STREAM variable = arg1_write_mem_redirect_strm 
        ...
        ops::hls::interleaveTileMem2stream2D<mem_data_width, 8, 0, 2, 1>(&arg0_read_mem_strm[0], memconfig, 
                            arg0_b0,
                            arg0_b1
        );   
        ops::hls::interleaveTileMem2stream2D<mem_data_width, 8, 2, 2, 1>(&arg0_read_mem_strm[2], memconfig, 
                            arg0_b2,
                            arg0_b3
        );   
        ops::hls::interleaveTileMem2stream2D<mem_data_width, 8, 4, 2, 1>(&arg0_read_mem_strm[4], memconfig, 
                            arg0_b4,
                            arg0_b5
        );   
        ops::hls::interleaveTileMem2stream2D<mem_data_width, 8, 6, 2, 1>(&arg0_read_mem_strm[6], memconfig, 
                            arg0_b6,
                            arg0_b7
        );   
         
        ops::hls::redirectTile2D<mem_data_width, 8, 1>(arg0_read_mem_strm, arg0_read_mem_redirect_strm, memconfig);
  
        ops::hls::stream2axisTileStepdown2D<mem_data_width, axis_data_width, 8, 0, 8, 1>(arg0_read_mem_redirect_strm, memconfig,
arg0_0_axis_out,
arg0_1_axis_out,
arg0_2_axis_out,
arg0_3_axis_out,
...
arg0_7_axis_out
        ...
        ops::hls::axis2streamTileStepup2D<mem_data_width, axis_data_width, 8, 0, 8, 1>(arg1_write_mem_redirect_strm, memconfig,
arg1_0_axis_in,
arg1_1_axis_in,
arg1_2_axis_in,
arg1_3_axis_in,
...
arg1_7_axis_in
        ...
        ops::hls::reverseRedirectTile2D<mem_data_width, 8, 1>(arg1_write_mem_redirect_strm, arg1_write_mem_strm, memconfig);
        ops::hls::interleaveTileStream2mem2D<mem_data_width, 8, 0, 2, 1>(&arg1_write_mem_strm[0], memconfig, 
                arg1_b0,
                arg1_b1
        );   
        ops::hls::interleaveTileStream2mem2D<mem_data_width, 8, 2, 2, 1>(&arg1_write_mem_strm[2], memconfig, 
                arg1_b2,
                arg1_b3
        );   
        ops::hls::interleaveTileStream2mem2D<mem_data_width, 8, 4, 2, 1>(&arg1_write_mem_strm[4], memconfig, 
                arg1_b4,
                arg1_b5
        );   
        ops::hls::interleaveTileStream2mem2D<mem_data_width, 8, 6, 2, 1>(&arg1_write_mem_strm[6], memconfig, 
                arg1_b6,
                arg1_b7
        );   
