// Auto-generated at 2026-07-30 23:47:33.086389 by ops-translator
...
slr_region, const ops::hls::StencilConfigCoreSingleTile stencilConfig,
    ::hls::stream<ap_uint<axis_data_width>> arg0_arg1_streams[iter_par_factor_2
+ 1]
)
{
#pragma HLS INLINE

    constexpr unsigned short PEId_offset = 37;
        ::hls::stream<ap_uint<axis_data_width>>
node2_1_to_node3_0[iter_par_factor_2]; #pragma HLS STREAM variable =
...
#pragma HLS ARRAY_PARTITION variable = node2_1_to_node3_0
  ...
  kernel_poisson_kernel_stencil_PE(37, 0, stencilConfig, arg0_arg1_streams[0],
                                   arg0_arg1_streams[0 + 1]);

  kernel_poisson_kernel_stencil_PE(37, 1, stencilConfig, arg0_arg1_streams[1],
                                   arg0_arg1_streams[1 + 1]);

  kernel_poisson_kernel_stencil_PE(37, 2, stencilConfig, arg0_arg1_streams[2],
                                   arg0_arg1_streams[2 + 1]);

  kernel_poisson_kernel_stencil_PE(37, 3, stencilConfig, arg0_arg1_streams[3],
                                   arg0_arg1_streams[3 + 1]);

  kernel_poisson_kernel_stencil_PE(37, 4, stencilConfig, arg0_arg1_streams[4],
                                   arg0_arg1_streams[4 + 1]);

  kernel_poisson_kernel_stencil_PE(37, 5, stencilConfig, arg0_arg1_streams[5],
                                   arg0_arg1_streams[5 + 1]);

  kernel_poisson_kernel_stencil_PE(37, 6, stencilConfig, arg0_arg1_streams[6],
                                   arg0_arg1_streams[6 + 1]);

  kernel_poisson_kernel_stencil_PE(37, 7, stencilConfig, arg0_arg1_streams[7],
                                   arg0_arg1_streams[7 + 1]);

  kernel_poisson_kernel_stencil_PE(37, 8, stencilConfig, arg0_arg1_streams[8],
                                   arg0_arg1_streams[8 + 1]);

  kernel_poisson_kernel_stencil_PE(37, 9, stencilConfig, arg0_arg1_streams[9],
                                   arg0_arg1_streams[9 + 1]);

  kernel_poisson_kernel_stencil_PE(37, 10, stencilConfig, arg0_arg1_streams[10],
                                   arg0_arg1_streams[10 + 1]);

  kernel_poisson_kernel_stencil_PE(37, 11, stencilConfig, arg0_arg1_streams[11],
                                   arg0_arg1_streams[11 + 1]);

  kernel_poisson_kernel_stencil_PE(37, 12, stencilConfig, arg0_arg1_streams[12],
                                   arg0_arg1_streams[12 + 1]);

  kernel_poisson_kernel_stencil_PE(37, 13, stencilConfig, arg0_arg1_streams[13],
                                   arg0_arg1_streams[13 + 1]);

  kernel_poisson_kernel_stencil_PE(37, 14, stencilConfig, arg0_arg1_streams[14],
                                   arg0_arg1_streams[14 + 1]);

  kernel_poisson_kernel_stencil_PE(37, 15, stencilConfig, arg0_arg1_streams[15],
                                   arg0_arg1_streams[15 + 1]);

  kernel_poisson_kernel_stencil_PE(37, 16, stencilConfig, arg0_arg1_streams[16],
                                   arg0_arg1_streams[16 + 1]);

  kernel_poisson_kernel_stencil_PE(37, 17, stencilConfig, arg0_arg1_streams[17],
                                   arg0_arg1_streams[17 + 1]);

  kernel_poisson_kernel_stencil_PE(37, 18, stencilConfig, arg0_arg1_streams[18],
                                   arg0_arg1_streams[18 + 1]);

  kernel_poisson_kernel_stencil_PE(37, 19, stencilConfig, arg0_arg1_streams[19],
                                   arg0_arg1_streams[19 + 1]);

  kernel_poisson_kernel_stencil_PE(37, 20, stencilConfig, arg0_arg1_streams[20],
                                   arg0_arg1_streams[20 + 1]);

  kernel_poisson_kernel_stencil_PE(37, 21, stencilConfig, arg0_arg1_streams[21],
                                   arg0_arg1_streams[21 + 1]);

  kernel_poisson_kernel_stencil_PE(37, 22, stencilConfig, arg0_arg1_streams[22],
                                   arg0_arg1_streams[22 + 1]);

  kernel_poisson_kernel_stencil_PE(37, 23, stencilConfig, arg0_arg1_streams[23],
                                   arg0_arg1_streams[23 + 1]);

  kernel_poisson_kernel_stencil_PE(37, 24, stencilConfig, arg0_arg1_streams[24],
                                   arg0_arg1_streams[24 + 1]);

  kernel_poisson_kernel_stencil_PE(37, 25, stencilConfig, arg0_arg1_streams[25],
                                   arg0_arg1_streams[25 + 1]);

  kernel_poisson_kernel_stencil_PE(37, 26, stencilConfig, arg0_arg1_streams[26],
                                   arg0_arg1_streams[26 + 1]);

  ops::hls::stream2axis<axis_data_width>(arg0_arg1_streams[iter_par_factor_2],
