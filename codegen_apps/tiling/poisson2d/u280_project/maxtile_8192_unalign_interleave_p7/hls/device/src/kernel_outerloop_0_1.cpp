// Auto-generated at 2026-08-18 12:56:49.562916 by ops-translator
...
#pragma HLS INLINE 
    ...
    ::hls::stream<ap_uint<half_axis_data_width_poisson_kernel_stencil_0>> arg0_poisson_kernel_stencil_in_subtile_stream[iter_par_factor_1][8];
    ...
    ::hls::stream<ap_uint<half_axis_data_width_poisson_kernel_stencil_1>> arg1_poisson_kernel_stencil_out_subtile_stream[iter_par_factor_1][8];
...
#pragma HLS DATAFLOW
    ...
    kernel_poisson_kernel_stencil_PE<4, 3>(
            ...
            ops::hls::updateInterleaveBoundaries<axis_data_width, 32, 8, 1>(arg1_poisson_kernel_stencil_out_subtile_stream[1], arg0_poisson_kernel_stencil_in_subtile_stream[2], num_pkts);
    kernel_poisson_kernel_stencil_PE<4, 0>(
                1, 2, 
                stencilConfig,
                arg0_poisson_kernel_stencil_in_subtile_stream[2][0],
                arg0_poisson_kernel_stencil_in_subtile_stream[2][1],
                arg1_poisson_kernel_stencil_out_subtile_stream[2][0],
                arg1_poisson_kernel_stencil_out_subtile_stream[2][1]
  
            );
    kernel_poisson_kernel_stencil_PE<4, 1>(
                1, 2, 
                stencilConfig,
                arg0_poisson_kernel_stencil_in_subtile_stream[2][2],
                arg0_poisson_kernel_stencil_in_subtile_stream[2][3],
                arg1_poisson_kernel_stencil_out_subtile_stream[2][2],
                arg1_poisson_kernel_stencil_out_subtile_stream[2][3]
  
            );
    kernel_poisson_kernel_stencil_PE<4, 2>(
                1, 2, 
                stencilConfig,
                arg0_poisson_kernel_stencil_in_subtile_stream[2][4],
                arg0_poisson_kernel_stencil_in_subtile_stream[2][5],
                arg1_poisson_kernel_stencil_out_subtile_stream[2][4],
                arg1_poisson_kernel_stencil_out_subtile_stream[2][5]
  
            );
    kernel_poisson_kernel_stencil_PE<4, 3>(
                1, 2, 
                stencilConfig,
                arg0_poisson_kernel_stencil_in_subtile_stream[2][6],
                arg0_poisson_kernel_stencil_in_subtile_stream[2][7],
                arg1_poisson_kernel_stencil_out_subtile_stream[2][6],
                arg1_poisson_kernel_stencil_out_subtile_stream[2][7]
  
            );
    ops::hls::interleave2stream<axis_data_width, 32, 8, 1>(arg1_poisson_kernel_stencil_out_subtile_stream[2], arg0_arg1_streams[1], num_pkts);
