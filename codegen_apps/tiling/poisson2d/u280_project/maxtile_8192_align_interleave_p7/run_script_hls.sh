    ...
    if [[ "${TARGET_MODE}" == "hw" ]]; then
        if [[ "${PLATFORM}" == *"u280"* ]]; then
            parameter_sets=(
                ...
                "5000,5000,1008,20,512"
                "10000,10000,1008,10,512"
                "15000,15000,1008,5,512"
                "20000,20000,1008,5,512"
                "1000,1000,1008,100,1024"
                "2500,2500,1008,100,1024"
                "5000,5000,1008,20,1024"
                "10000,10000,1008,10,1024"
                "15000,15000,1008,5,1024"
                "20000,20000,1008,5,1024"
                "1000,1000,1008,100,2048"
                "2500,2500,1008,100,2048"
                "5000,5000,1008,20,2048"
                "10000,10000,1008,10,2048"
                "15000,15000,1008,5,2048"
                "20000,20000,1008,5,2048"
                "1000,1000,1008,100,4096"
                "2500,2500,1008,100,4096"
                "5000,5000,1008,20,4096"
                "10000,10000,1008,10,4096"
                "15000,15000,1008,5,4096"
                "20000,20000,1008,5,4096"
                "1000,1000,1008,100,8192"
                "2500,2500,1008,100,8192"
                "5000,5000,1008,20,8192"
                "10000,10000,1008,10,8192"
                "15000,15000,1008,5,8192"
                "20000,20000,1008,5,8192"
