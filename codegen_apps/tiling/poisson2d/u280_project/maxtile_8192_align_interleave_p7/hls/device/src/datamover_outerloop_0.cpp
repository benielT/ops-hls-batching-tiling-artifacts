// Auto-generated at 2026-08-18 17:01:51.351082 by ops-translator
        ...
        ::hls::stream<ap_uint<MEM_DATA_WIDTH>>& strm_out, const ap_uint<128>& command )
{
	...
	//#pragma HLS STREAM variable = strm_internal depth = 32
...
)    
{
    ...
    ::hls::stream<ap_uint<mem_data_width>> arg0_read_mem_strm_g0[2];
    #pragma HLS STREAM variable = arg0_read_mem_strm_g0 depth=16
    ::hls::stream<ap_uint<mem_data_width>> arg0_read_mem_strm_g1[2];
    #pragma HLS STREAM variable = arg0_read_mem_strm_g1 depth=16
    ::hls::stream<ap_uint<mem_data_width>> arg0_read_mem_strm_g2[2];
    #pragma HLS STREAM variable = arg0_read_mem_strm_g2 depth=16
    ::hls::stream<ap_uint<mem_data_width>> arg0_read_mem_strm_g3[2];
    #pragma HLS STREAM variable = arg0_read_mem_strm_g3 depth=16

    
    ::hls::stream<ap_uint<mem_data_width>> arg1_write_mem_strm_g0[2];
    #pragma HLS STREAM variable = arg1_write_mem_strm_g0 depth=16
    ::hls::stream<ap_uint<mem_data_width>> arg1_write_mem_strm_g1[2];
    #pragma HLS STREAM variable = arg1_write_mem_strm_g1 depth=16
    ::hls::stream<ap_uint<mem_data_width>> arg1_write_mem_strm_g2[2];
    #pragma HLS STREAM variable = arg1_write_mem_strm_g2 depth=16
    ::hls::stream<ap_uint<mem_data_width>> arg1_write_mem_strm_g3[2];
    #pragma HLS STREAM variable = arg1_write_mem_strm_g3 depth=16
        ...
        ops::hls::interleaveTileMem2stream2D<mem_data_width, 8, 0, 2, 1>(arg0_read_mem_strm_g0, memconfig, 
                            arg0_b0,
                            arg0_b1
        );   
        ops::hls::interleaveTileMem2stream2D<mem_data_width, 8, 2, 2, 1>(arg0_read_mem_strm_g1, memconfig, 
                            arg0_b2,
                            arg0_b3
        );   
        ops::hls::interleaveTileMem2stream2D<mem_data_width, 8, 4, 2, 1>(arg0_read_mem_strm_g2, memconfig, 
                            arg0_b4,
                            arg0_b5
        );   
        ops::hls::interleaveTileMem2stream2D<mem_data_width, 8, 6, 2, 1>(arg0_read_mem_strm_g3, memconfig, 
                            arg0_b6,
                            arg0_b7
        );   
         
        ops::hls::stream2axisTileStepdown2D<mem_data_width, axis_data_width, 8, 0, 2, 1>(arg0_read_mem_strm_g0, memconfig,
arg0_0_axis_out,
arg0_1_axis_out
        );
        ops::hls::stream2axisTileStepdown2D<mem_data_width, axis_data_width, 8, 2, 2, 1>(arg0_read_mem_strm_g1, memconfig,
arg0_2_axis_out,
arg0_3_axis_out
        );
        ops::hls::stream2axisTileStepdown2D<mem_data_width, axis_data_width, 8, 4, 2, 1>(arg0_read_mem_strm_g2, memconfig,
arg0_4_axis_out,
arg0_5_axis_out
        );
        ops::hls::stream2axisTileStepdown2D<mem_data_width, axis_data_width, 8, 6, 2, 1>(arg0_read_mem_strm_g3, memconfig,
arg0_6_axis_out,
arg0_7_axis_out
        );
        ...
        ops::hls::axis2streamTileStepup2D<mem_data_width, axis_data_width, 8, 0, 2, 1>(arg1_write_mem_strm_g0, memconfig,
arg1_0_axis_in,
arg1_1_axis_in
        );
        ops::hls::axis2streamTileStepup2D<mem_data_width, axis_data_width, 8, 2, 2, 1>(arg1_write_mem_strm_g1, memconfig,
arg1_2_axis_in,
arg1_3_axis_in
        );
        ops::hls::axis2streamTileStepup2D<mem_data_width, axis_data_width, 8, 4, 2, 1>(arg1_write_mem_strm_g2, memconfig,
arg1_4_axis_in,
arg1_5_axis_in
        );
        ops::hls::axis2streamTileStepup2D<mem_data_width, axis_data_width, 8, 6, 2, 1>(arg1_write_mem_strm_g3, memconfig,
arg1_6_axis_in,
arg1_7_axis_in
        );
        ops::hls::interleaveTileStream2mem2D<mem_data_width, 8, 0, 2, 1>(arg1_write_mem_strm_g0, memconfig, 
                arg1_b0,
                arg1_b1
        );   
        ops::hls::interleaveTileStream2mem2D<mem_data_width, 8, 2, 2, 1>(arg1_write_mem_strm_g1, memconfig, 
                arg1_b2,
                arg1_b3
        );   
        ops::hls::interleaveTileStream2mem2D<mem_data_width, 8, 4, 2, 1>(arg1_write_mem_strm_g2, memconfig, 
                arg1_b4,
                arg1_b5
        );   
        ops::hls::interleaveTileStream2mem2D<mem_data_width, 8, 6, 2, 1>(arg1_write_mem_strm_g3, memconfig, 
                arg1_b6,
                arg1_b7
        );   
    ...
    for (int i = 0; i < 2; i++) {
        if(!arg0_read_mem_strm_g0[i].empty())
            printf("[SIM WARNING] arg0_read_mem_strm_g0[%d] has %zu leftover elements!\n", i, arg0_read_mem_strm_g0[i].size());
    }           
    for (int i = 0; i < 2; i++) {
        if(!arg0_read_mem_strm_g1[i].empty())
            printf("[SIM WARNING] arg0_read_mem_strm_g1[%d] has %zu leftover elements!\n", i, arg0_read_mem_strm_g1[i].size());
    }           
    for (int i = 0; i < 2; i++) {
        if(!arg0_read_mem_strm_g2[i].empty())
            printf("[SIM WARNING] arg0_read_mem_strm_g2[%d] has %zu leftover elements!\n", i, arg0_read_mem_strm_g2[i].size());
    }           
    for (int i = 0; i < 2; i++) {
        if(!arg0_read_mem_strm_g3[i].empty())
            printf("[SIM WARNING] arg0_read_mem_strm_g3[%d] has %zu leftover elements!\n", i, arg0_read_mem_strm_g3[i].size());
    }           
    for (int i = 0; i < 2; i++) {
        if(!arg1_write_mem_strm_g0[i].empty())
            printf("[SIM WARNING] arg1_write_mem_strm_g0[%d] has %zu leftover elements!\n", i, arg1_write_mem_strm_g0[i].size());
    }           
    for (int i = 0; i < 2; i++) {
        if(!arg1_write_mem_strm_g1[i].empty())
            printf("[SIM WARNING] arg1_write_mem_strm_g1[%d] has %zu leftover elements!\n", i, arg1_write_mem_strm_g1[i].size());
    }           
    for (int i = 0; i < 2; i++) {
        if(!arg1_write_mem_strm_g2[i].empty())
            printf("[SIM WARNING] arg1_write_mem_strm_g2[%d] has %zu leftover elements!\n", i, arg1_write_mem_strm_g2[i].size());
    }           
    for (int i = 0; i < 2; i++) {
        if(!arg1_write_mem_strm_g3[i].empty())
            printf("[SIM WARNING] arg1_write_mem_strm_g3[%d] has %zu leftover elements!\n", i, arg1_write_mem_strm_g3[i].size());
    }           
    // -------------------------------------------------------------------------
#endif
#endif
...

{
    ...
    #pragma HLS INTERFACE mode=axis port=arg0_0_axis_out register 
    #pragma HLS INTERFACE mode=axis port=arg0_1_axis_out register 
    #pragma HLS INTERFACE mode=axis port=arg0_2_axis_out register 
    #pragma HLS INTERFACE mode=axis port=arg0_3_axis_out register 
    #pragma HLS INTERFACE mode=axis port=arg0_4_axis_out register 
    #pragma HLS INTERFACE mode=axis port=arg0_5_axis_out register 
    #pragma HLS INTERFACE mode=axis port=arg0_6_axis_out register 
    #pragma HLS INTERFACE mode=axis port=arg0_7_axis_out register 
    #pragma HLS INTERFACE mode=axis port=arg1_0_axis_in register 
    #pragma HLS INTERFACE mode=axis port=arg1_1_axis_in register 
    #pragma HLS INTERFACE mode=axis port=arg1_2_axis_in register 
    #pragma HLS INTERFACE mode=axis port=arg1_3_axis_in register 
    #pragma HLS INTERFACE mode=axis port=arg1_4_axis_in register 
    #pragma HLS INTERFACE mode=axis port=arg1_5_axis_in register 
    #pragma HLS INTERFACE mode=axis port=arg1_6_axis_in register 
    #pragma HLS INTERFACE mode=axis port=arg1_7_axis_in register 
