    ...
    if [[ "${TARGET_MODE}" == "hw" ]]; then
        if [[ "${PLATFORM}" == *"u280"* ]]; then
            ...
            parameter_sets=(
                ...
                "300,300,300,1800,2,1"
                "256,256,32,1800,2,1"
                "512,256,64,1800,2,1"
                "512,512,128,1800,2,1"
                "30,30,30,104,100,10"
                "30,30,50,1800,100,10"
                "50,50,16,1800,100,10"
                "50,50,30,1800,50,10"
                "50,50,50,1800,50,10"
                "75,75,75,1800,50,10"
                ...
                "30,30,30,104,500,50"
                "30,30,50,1800,500,50"
                "50,50,16,1800,500,50"
                "50,50,30,1800,500,50"
                "50,50,50,1800,500,50"
                "75,75,75,1800,200,50"
                "100,100,100,1800,200,50"
                # Add more parameter sets here as needed
                )
        fi
    else
